...
public class Urls {
    ...
    // 头条
    public static final String TOP_URL = NEWS_HOST + "nc/article/headline/";
    public static final String TOP_ID = "T1348647909107";
    // 新闻详情
    public static final String NEW_DETAIL = NEWS_HOST + "nc/article/";

    public static final String COMMON_URL = NEWS_HOST + "nc/article/list/";
    ...
    //////////图片部分////////
    public static final String PHOTO_HOST = "http://gank.io/api/search/query/listview/category/%E7%A6%8F%E5%88%A9/count/50/page/";
}
